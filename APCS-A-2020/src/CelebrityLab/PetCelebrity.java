 ...
 */
public class PetCelebrity extends Celebrity
{
	/**
	 ...
	 */
	public PetCelebrity(String answer, String clues)
	{
		super(answer, clues);
		processClues();
	}
	
	public PetCelebrity(String answer, String clue, String type) {
		super(answer,clue,type);
		processClues();
	}
	...
	{
		String dsc = "This is the animal celebrity: " + getAnswer() + "\nThe clues are:\n";
